...
export const SITE_CONFIG = {
  ...
  keywords:
    "Mahadev Book, Mahadev Book ID, Mahadev Book Login, Mahadev Book Register, Buy Mahadev Book ID, Mahadev Game ID",
  ogImage: "/images/mahadev-book-banner.webp",
  whatsappLink: "https://wa.me/916026703858",
  creator: "Mahadev Book",
  publisher: "Mahadev Book",
  googleVerification: "4M_idkDdobkwjDcJ2PlVfbsipbIOyjE6WahPGfZY-P0",
};
